...
namespace PharmaProject.Server.Migrations
{
    ...
    public partial class migration3 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
          ...
          @"
                INSERT INTO Pharmacies (Name, Address, City, StateCode, Zip, FilledPerscriptions, CreatedDate, CreatedBy)
                VALUES
                ('Walgreens', '123 Main St.', 'Dallas', 'TX', 75201, 0, GETDATE(), 'Sydney.Jeffriess@gmail.com'),
                ('Sydney''s Pharmacy', '123 Juniper Rd', 'Plano', 'TX', 75074, 0, GETDATE(), 'Sydney.Jeffriess@gmail.com'),
                ('CVS', '501 McAuthor Blvd.', 'Irving', 'TX', 75014, 0, GETDATE(), 'Sydney.Jeffriess@gmail.com'),
                ('Ecards', '123 7th St', 'Ft Worth', 'TX', 75050, 0, GETDATE(), 'Sydney.Jeffriess@gmail.com'),
                ('Target pharmacy', 'Glade Rd', 'Colleyville', 'TX', 76001, 0, GETDATE(), 'Sydney.Jeffriess@gmail.com')
                ");
